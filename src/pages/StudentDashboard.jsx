...
// Add these missing imports to your existing import statement from "lucide-react":
import {
  AlertCircle,
  Clock,
  CheckCircle,
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                  ...
                  <ul className="text-sm text-green-700 space-y-1">
                    <li>• Hostel A - Near Faculty cafeteria</li>
                    <li>• Hostel B - Near EIE Department</li>
                    <li>• Hostel D - Near Gymnasium</li>
                  </ul>
                </div>
                ...
                <div className="bg-pink-50 rounded-lg p-4 border border-pink-200">
                  ...
                  <ul className="text-sm text-pink-700 space-y-1">
                    <li>• Hostel C - Near Faculty cafeteria</li>
                    <li>• All within 2-10 minutes walk to departments</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                  ...
                  <ul className="text-sm text-blue-700 space-y-1">
                    <li>• Department Buildings</li>
                    <li>• Faculty Library</li>
                    <li>• Lecture Halls</li>
                    <li>• Computer Labs</li>
                  </ul>
                </div>
                ...
                <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
                  ...
                  <ul className="text-sm text-purple-700 space-y-1">
                    <li>• Faculty Cafeteria</li>
                    <li>• Gymnasium & Sports</li>
                ...
                <div className="bg-orange-50 rounded-lg p-4 border border-orange-200">
                  ...
                  <ul className="text-sm text-orange-700 space-y-1">
                    <li>• Hostels A, B, C: 2 min to classes</li>
                    <li>• Hostel D: 10 min to classes</li>
                    <li>• All hostels: On-campus location</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-blue-700 text-sm">
                      All hostels are located within the Faculty of Engineering
                      campus. Use the faculty cafeteria and main department
                      buildings as central landmarks for easy navigation.
                    </p>
                  </div>
                </div>
              </div>
    ...
    <div className="bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
      <div className="bg-gradient-to-r from-yellow-500 to-orange-500 p-6 text-white">
        ...
        <p className="text-yellow-100 mt-2">
          Find answers to common questions and get support for your hostel accommodation.
        </p>
      </div>
      ...
      <div className="p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-yellow-50 rounded-lg p-5 border border-yellow-200">
            ...
            <div className="space-y-4">
              <div>
                <h5 className="font-medium text-yellow-800 mb-2">How do I apply for hostel accommodation?</h5>
                <p className="text-yellow-700 text-sm">
                  Click on "Apply for Accommodation" in your dashboard or use the Apply button. Fill out all required 
                  information including personal details, academic information, and family details.
                </p>
              </div>
              <div>
                <h5 className="font-medium text-yellow-800 mb-2">How long does the approval process take?</h5>
                <p className="text-yellow-700 text-sm">
                  The review process typically takes 3-5 business days. You'll receive updates on your application 
                  status through your dashboard.
                </p>
              </div>
              <div>
                <h5 className="font-medium text-yellow-800 mb-2">Can I edit my application after submission?</h5>
                <p className="text-yellow-700 text-sm">
                  Once submitted, applications cannot be edited. If you need to make changes, contact the 
          ...
          <div className="bg-blue-50 rounded-lg p-5 border border-blue-200">
            ...
            <div className="space-y-4">
              <div>
                <h5 className="font-medium text-blue-800 mb-2">When will I get my room assignment?</h5>
                <p className="text-blue-700 text-sm">
                  Room assignments are made after application approval. You'll see your hostel and room number 
                  in your dashboard once assigned.
                </p>
              </div>
              <div>
                <h5 className="font-medium text-blue-800 mb-2">How do I collect my room key?</h5>
                <p className="text-blue-700 text-sm">
                  Visit the administration office with your student ID and approval notification. Office hours 
                  are Monday-Friday, 8:00 AM - 4:00 PM.
                </p>
              </div>
              <div>
                <h5 className="font-medium text-blue-800 mb-2">Can I request a specific hostel or room?</h5>
                <p className="text-blue-700 text-sm">
                  Room assignments are made based on availability and administrative criteria. Special requests 
                  can be submitted but are not guaranteed.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-green-50 rounded-lg p-5 border border-green-200">
            ...
            <div className="space-y-4">
              <div>
                <h5 className="font-medium text-green-800 mb-2">How much does hostel accommodation cost?</h5>
                <p className="text-green-700 text-sm">
                  Accommodation is free for students. Only a small annual fee of approximately Rs. 1000 
                  is charged for the student welfare fund.
                </p>
              </div>
              <div>
                <h5 className="font-medium text-green-800 mb-2">When and how do I pay the welfare fund fee?</h5>
                <p className="text-green-700 text-sm">
                  The welfare fund fee is collected during the registration process. Payment details will be 
                  provided by the administration office.
                </p>
              </div>
              <div>
                <h5 className="font-medium text-green-800 mb-2">Are there any additional charges?</h5>
                <p className="text-green-700 text-sm">
                  No additional charges for basic accommodation. However, damage to hostel property may result 
                  in repair costs.
                </p>
              </div>
            </div>
          ...
          <div className="bg-orange-50 rounded-lg p-5 border border-orange-200">
            ...
            <div className="space-y-4">
              <div>
                <h5 className="font-medium text-orange-800 mb-2">How do I report maintenance issues?</h5>
                <p className="text-orange-700 text-sm">
                  Use the "Report Issue" button in your dashboard. Select the appropriate category and provide 
                  detailed information about the problem.
                </p>
              </div>
              <div>
                <h5 className="font-medium text-orange-800 mb-2">How quickly are issues resolved?</h5>
                <p className="text-orange-700 text-sm">
                  Response time depends on priority level. Urgent issues are addressed within 24 hours, 
                  while routine maintenance may take 2-5 days.
                </p>
              </div>
              <div>
                <h5 className="font-medium text-orange-800 mb-2">What if I have an emergency?</h5>
                <p className="text-orange-700 text-sm">
                  For emergencies, contact the security office at the main gate (available 24/7) or 
                  the hostel warden immediately.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-purple-50 rounded-lg p-5 border border-purple-200">
            ...
            <div className="space-y-4">
              <div>
                <h5 className="font-medium text-purple-800 mb-2">What are the check-in/check-out times?</h5>
                <p className="text-purple-700 text-sm">
                  Check-in is from 6:00 AM to 10:00 PM. Late entry requires prior permission from the warden. 
                  Check the Hostel Regulations for complete details.
                </p>
              </div>
              <div>
                <h5 className="font-medium text-purple-800 mb-2">Can I have guests in my room?</h5>
                <p className="text-purple-700 text-sm">
                  Guests must be registered at the front desk and can stay for a maximum of 2 days with approval. 
                  All visitors must follow hostel rules.
                </p>
              </div>
              <div>
                <h5 className="font-medium text-purple-800 mb-2">What happens if I violate hostel rules?</h5>
                <p className="text-purple-700 text-sm">
                  Violations may result in warnings, fines, or termination of accommodation. Serious violations 
                  are reported to academic authorities.
                </p>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">Administration Office: Main Building</span>
                </div>
                <div className="flex items-center">
                  <Clock className="h-4 w-4 text-gray-500 mr-2" />
                  <span className="text-gray-700">Office Hours: Mon-Fri, 8:00 AM - 4:00 PM</span>
                </div>
                <div className="flex items-center">
                  <Shield className="h-4 w-4 text-gray-500 mr-2" />
                  <span className="text-gray-700">Security: Main Gate - 24/7</span>
                </div>
              </div>
            </div>
            <div>
              <h5 className="font-medium text-gray-800 mb-3">Digital Support</h5>
              <div className="space-y-2 text-sm">
                <div className="flex items-center">
                  <Bug className="h-4 w-4 text-gray-500 mr-2" />
                  <span className="text-gray-700">Report issues through your dashboard</span>
                </div>
                <div className="flex items-center">
                  <Bell className="h-4 w-4 text-gray-500 mr-2" />
                  <span className="text-gray-700">Check notices for important updates</span>
                </div>
                <div className="flex items-center">
                  <MapPin className="h-4 w-4 text-gray-500 mr-2" />
                  <span className="text-gray-700">Use campus map for navigation</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-start">
            <Info className="h-5 w-5 text-blue-500 mt-0.5 mr-3 flex-shrink-0" />
            <div>
              <h5 className="font-medium text-blue-800 mb-2">Quick Tips for New Students</h5>
