...
=======
  Upload,
  CreditCard
>>>>>>> 6f2b69b71bdee5903f5c80624fde1414b79d9aa5
} from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`transition-all duration-700 ease-in-out transform ${activateAnimation ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          ...
          {applications.some(app => app.status === 'approved') && notices.length > 0 && (
                              ...
                              <div className="mb-4">
                                {application.paymentInfo ? (
                                  <div className={`border rounded-xl p-4 flex items-start ${
                                    application.paymentInfo.status === 'approved'
                                      ? 'bg-green-50 border-green-200'
                                      : application.paymentInfo.status === 'rejected'
                                    ...
                                    <div>
                                      ...
                                      <p className={`text-sm mt-1 ${
                                        ...
                                        {application.paymentInfo.status === 'approved'
                                          ? `LKR ${application.paymentInfo.amount} payment approved on ${new Date(application.paymentInfo.approvedDate).toLocaleDateString()}`
                                          : application.paymentInfo.status === 'rejected'
                                          ? `Payment receipt was rejected. Please upload a valid receipt.`
                                          : `LKR ${application.paymentInfo.amount} payment receipt uploaded on ${new Date(application.paymentInfo.uploadDate).toLocaleDateString()}. Awaiting admin approval.`
                                        }
                                      </p>
                                    </div>
                                  </div>
                                  ...
                                  <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 flex items-start">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-orange-700 text-sm mt-1">
                                        Please upload your bank receipt showing payment of LKR 1,500 annual hostel fees.
                                      </p>
                                    </div>
                                  </div>
                                )}
                              ...
                              <div className="space-y-4">
                                ...
                                <div className="bg-white rounded-lg p-4 border border-gray-100">
                                  ...
                                  <div className="space-y-3">
                                    ...
                                    {application.gramaNiladhariRecommendationUrl && (
                                      <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg border border-green-200">
                                        <div className="flex items-center">
                                          ...
                                          <div>
                                            <h6 className="font-medium text-gray-900 text-sm">Grama Niladhari Recommendation</h6>
                                            <p className="text-xs text-gray-600">Official certification document</p>
                                          </div>
                                        </div>
                                        <div className="flex space-x-2">
                                          <button
                                            onClick={() => window.open(application.gramaNiladhariRecommendationUrl, '_blank')}
                                    ...
                                    {application.physicalEducationRecommendationUrl && (
                                      <div className="flex items-center justify-between p-3 bg-orange-50 rounded-lg border border-orange-200">
                                        <div className="flex items-center">
                                          ...
                                          <div>
                                            <h6 className="font-medium text-gray-900 text-sm">Physical Education Recommendation</h6>
                                            <p className="text-xs text-gray-600">Sports activities certification</p>
                                          </div>
                                        </div>
                                        <div className="flex space-x-2">
                                          <button
                                            onClick={() => window.open(application.physicalEducationRecommendationUrl, '_blank')}
                                    ...
                                    {application.additionalDocumentsUrls && application.additionalDocumentsUrls.length > 0 && (
                                      <div className="space-y-2">
                                        <h6 className="font-medium text-gray-700 text-sm flex items-center">
                                          <Users className="h-4 w-4 text-purple-600 mr-2" />
                                          Additional Supporting Documents ({application.additionalDocumentsUrls.length})
                                        </h6>
                                        {application.additionalDocumentsUrls.map((doc, index) => (
                                          <div key={index} className="flex items-center justify-between p-3 bg-purple-50 rounded-lg border border-purple-200">
                                            <div className="flex items-center">
                                              <FileText className="h-4 w-4 text-purple-600 mr-3" />
                                              <div>
                                                <h6 className="font-medium text-gray-900 text-sm">{doc.name || `Document ${index + 1}`}</h6>
                                    ...
                                    {application.paymentInfo && (
                                      <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg border border-blue-200">
                                        <div className="flex items-center">
                                          ...
                                          <div>
                                            <h6 className="font-medium text-gray-900 text-sm">Payment Receipt</h6>
                                            <p className="text-xs text-gray-600">LKR {application.paymentInfo.amount} - {application.paymentInfo.fileName}</p>
                                          </div>
                                        </div>
                                        <div className="flex space-x-2">
                                          <button
                                            onClick={() => window.open(application.paymentInfo.receiptUrl, '_blank')}
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-blue-700 text-sm mt-1">
                      Please upload your bank receipt showing payment of LKR 1,500 for annual hostel fees.
